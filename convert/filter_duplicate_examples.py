import json
data = []
with open('/data/caijie/analyse_bert/data/sync_shortcut/sync_shortcut.json','r',encoding='utf-8') as fin:
...
with open('/data/caijie/analyse_bert/data/sync_shortcut/sync_shortcut_new.json','w',encoding='utf-8') as fout:
